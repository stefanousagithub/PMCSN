 ...
 */
{
  ...
  double BoundedPareto(double a, double k, double p)
/* ---------------------------------------------------
* generate a Bounded Pareto random variate, use 0 < a < 2, k > 0, p > k
* if k == 0.9324, a == 1.5, p == 10.0, mean arrival time == 2
* if k == 0.7285, a == 1.5, p == 100.0, mean arrival time == 2
*  --------------------------------------------------- */
{
  return (k/pow(1.0 - Random() * (1.0 - pow(k/p, a)), 1/a));
}

  double Pareto(double a, double k)
/* ---------------------------------------------------
* generate a Pareto random variate, use 0 < a < 2, k > 0
*  --------------------------------------------------- */
{
  return (k/pow(1.0 - Random(), 1/a));
}
